  ...
  return (
    ...
    >
      <Helmet>
        ...
        <meta
          name="description"
          content="Hi, I'm Rishiwant, a web developer passionate about creating innovative web solutions. Connect with me to discuss web development and explore my projects."
        />
        {/* Open Graph tags */}
        <meta property="og:title" content="Rishiwant - Web Developer" />
        <meta
        ...
        <meta name="twitter:title" content="Rishiwant - Web Developer" />
        <meta
      ...
      <div className="self-img">
        <img className="w-[70vw] lg:w-96" src={HeroImg} alt="Rishiwant" />
      </div>
    </motion.div>
  );
};
