  ...
  return (
    ...
    >
       <Helmet>
        ...
        <meta
          name="description"
          content="Explore a collection of projects developed by Rishiwant. From web development to open source contributions, discover the diverse projects that showcase Rishi's skills and expertise."
        />
        {/* Open Graph tags */}
        <meta property="og:title" content="My Projects - Rishiwant" />
        <meta
        ...
        <meta name="twitter:title" content="My Projects - Rishiwant" />
        <meta
